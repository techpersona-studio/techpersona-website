(function(){
  ...
  var STRINGS = {
    en: {
      ...
      hero_location_line: 'Website redesigns and automation solutions for local businesses falling behind the tech curve.',
      ...
      build_h2: 'Website redesign and lead automation for Worcester, MA local businesses. <span class="serif-i">Take the one you need.</span>',
    ...
    vi: {
      ...
      hero_location_line: 'Thiết kế lại website và giải pháp tự động hóa cho các doanh nghiệp cần nâng cấp trải nghiệm số.',
      ...
      build_h2: 'Thiết kế lại website và tự động hóa khách hàng tiềm năng cho doanh nghiệp dịch vụ ở Worcester, MA. <span class="serif-i">Chọn phần bạn cần.</span>',
