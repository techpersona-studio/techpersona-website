(function(){
  ...
  var STRINGS = {
    en: {
      ...
      proof_reviews_body: "First client reviews are on the way. See the before and after above, and I'll add named reviews here the moment they land.",
    ...
    vi: {
      ...
      proof_reviews_body: 'Những đánh giá đầu tiên từ khách hàng sắp có. Hãy xem phần trước và sau ở trên, tôi sẽ bổ sung các đánh giá có tên ngay khi nhận được.',
