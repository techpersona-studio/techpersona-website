(function(){
  ...
  var STRINGS = {
    en: {
      ...
      hero_location_line: 'Websites, search visibility, and quiet automation for local businesses falling behind the tech curve.',
      ...
      // ---- /work measured speed ----
      perfk_qp_before: 'worst case, before a customer saw anything on their phone',
      perfk_qp_after: 'faster on mobile',
      perfk_yg_before: 'before the main image appeared',
      ...
      // ---- /work teasers ----
      teaser_qp_name: 'Quán Phở',
      teaser_qp_kind: 'Vietnamese restaurant · Saugus, MA',
      teaser_yg_name: 'Young Group',
      teaser_yg_kind: 'Weight-loss coaching · bilingual, 7 pages',
      teaser_go: 'See what changed <span class="a" aria-hidden="true">&#8594;</span>',

      // ---- /work page ----
      work_h1: 'Two rebuilds, <span class="serif-i">start to finish.</span>',
      work_lead: "Both sites below were audited, designed, built, and handed over by me. No subcontractors, no handoffs. Here's what changed on each, and why.",
      work_label_before: 'Before',
      work_label_after: 'After',
      qp_h2: 'Quán Phở, rebuilt.',
      qp_lead: 'A Vietnamese restaurant in Saugus, MA. Same business, completely different first impression.',
      qp_ba_head: 'Restaurant website redesign',
      qp_ba_sub: 'Saugus, MA · menu, karaoke nights, private events',
      qp_b1: "Generic template, stock photos that weren't Vietnamese food",
      qp_b2: 'Three links in the nav, no hours, no address',
      qp_b3: 'Nothing about karaoke nights or private events',
      qp_b4: "Mobile navigation didn't work at all",
      qp_a1: 'Their real food and branding, front and centre',
      qp_a2: 'Two clear paths: order online, or book the whole restaurant',
      qp_a3: 'Private-event enquiries reach the owner by email and text in seconds',
      qp_a4: 'Owner updates the menu from a Google Sheet, no developer, no invoice',
      qp_a5: '1.6 MB of images cut, 44% smaller, same quality on screen',
      qp_note: "Rebuilt with permission. The new site goes live at the owner's pace.",
      yg_h2: 'Young Group, rebuilt.',
      yg_lead: 'A 1-on-1 weight-loss coaching practice serving Vietnamese clients across the US, Vietnam, Australia and Canada. One landing page became a seven-page bilingual site.',
      yg_ba_head: 'Bilingual redesign & SEO for health coaching',
      yg_live_badge: 'Visit live site ↗',
      yg_ba_sub: 'Health coaching · Vietnamese and English · 7 pages',
      yg_b1: 'One long landing page, no About, Results, FAQ or blog',
      yg_b2: 'Vietnamese only, with no English at all',
      yg_b3: 'Client results buried in an unreadable wall of images',
      yg_b4: 'Scored 29 out of 100 on my SEO and AI-search audit',
      yg_a1: 'Seven pages: home, team, results, video, blog, FAQ, contact',
      yg_a2: 'Properly bilingual, real English pages, not a toggle',
      yg_a3: 'Every client story opens on its own, with the before and after',
      yg_a4: 'Built for Google and for AI answers to read correctly',
      yg_a5: "A blog that pulls in search traffic, articles written and published for her",
      yg_note: 'Rebuilt with permission, now live at <a href="https://tranthuytien.net" target="_blank" rel="noopener">tranthuytien.net</a>.',
      samples_h2: 'Sample builds.',
      samples_lead: "These are mine, not clients'. Builds I made to work out how a vertical should feel. No real business, no claimed result. They're here so you can judge the craft.",
      sample_1: 'Real estate',
      sample_2: 'E-commerce',
      work_cta_h2: 'Want to see what yours <span class="serif-i">could look like?</span>',
      work_cta_btn: 'Send me your URL <span class="ic" aria-hidden="true">&#8594;</span>',
      work_cta_trust: 'Free · no commitment · audit in 2 days',
      build_h2: 'Websites, search visibility, and lead automation for Worcester, MA local businesses. <span class="serif-i">Take the one you need.</span>',
      build_lead: 'One gets you found. One keeps you visible when people search, on Google and in AI answers. One makes sure nobody slips through after they reach out. Start with whichever your biggest leak calls for.',
      build_included: "Start with a free audit <span class=\"a\" aria-hidden=\"true\">&#8594;</span>",
      build_included_03: "Find your biggest win, free <span class=\"a\" aria-hidden=\"true\">&#8594;</span>",
      build_not_for: "I'd rather build one site properly than five quickly. Every build is designed from scratch, measured for speed and security before it ships, and set up so search and AI can read it. That is not the cheapest way to work, so I'm probably not a fit if price is the deciding factor.",
      ...
      build_01_li2: 'Built so Google and AI answers can read your business correctly',
      build_01_li3: 'Every page nudges toward one next step: book, call, or order',
      build_01_li4: 'Designed for you from scratch, never a template another business is also running',
      build_01_li5: 'Speed and security measured before launch, not promised',
      build_01_tag: 'One-time build, scoped before you commit. The foundation is here; the climb is Service 02.',
      build_01_t1: 'Launch <em>1 page</em>',
      build_01_t1_p: '$950',
      build_01_t2: 'Growth <em>2\u20135 pages</em>',
      build_01_t2_p: '$1,850',
      build_01_t3: 'Custom <em>6+ pages, multi-language</em>',
      build_01_t3_p: 'from $2,500',
      build_02_t1: 'Full SEO & AI report <em>scored, one-time</em>',
      build_02_t1_p: '$97',
      build_02_t2: 'Fix sprint <em>one-time</em>',
      build_02_t2_p: '$899',
      build_02_t3: 'Growth <em>ongoing</em>',
      build_02_t3_p: '$969/mo',
      build_03_t1: 'Never Miss a Call <em>text-back</em>',
      build_03_t1_p: '$499 + $79/mo',
      build_03_t2: 'Lead Catcher <em>+ form routing</em>',
      build_03_t2_p: '$899 + $149/mo',
      build_03_t3: 'Custom systems <em>scoped</em>',
      build_03_t3_p: 'from $1,500',
      build_promise: "The first audit is free whichever you pick. Every price below is real, you'll never book a call just to find out what something costs.",
      build_02_num: 'Service 02',
      build_02_h3: 'SEO & AI search',
      build_02_body: "Google still sends people to a list of links. ChatGPT, Perplexity and Google's AI answers read your site and name one business, or skip you because they couldn't read it. I work on both.",
      build_02_scenario: 'Someone asks ChatGPT who to call for a leaking roof in Worcester. <b>Your business gets named</b>, because your site was built for AI to read.',
      build_02_li1: 'Found on Google, and quoted in AI answers',
      build_02_li2: 'A Google Business Profile that actually brings calls',
      build_02_li3: 'Articles that answer what your customers already search for',
      build_02_tag: 'Audit credits toward the sprint \u00b7 3-month minimum on Growth',
      build_03_num: 'Service 03',
      build_03_h3: 'Quiet systems',
      build_03_body: 'The lead-catching that runs while you work. Missed calls and after-hours messages get an instant, friendly reply and reach the right person.',
      build_03_scenario: 'A new inquiry comes in at 11pm. <b>Your system texts back in under 2 minutes</b> with a booking link. You wake up to a scheduled call.',
      build_03_li1: 'Nothing for you to learn or log into',
      build_03_li2: 'Runs quietly in the background',
      build_03_li3: 'Add it to any site, mine or yours',
      build_03_tag: 'Add-on or standalone \u00b7 phone and SMS billed to you at cost',

      proof_h2: 'Two businesses, rebuilt.',
      proof_lead: "Real clients, real briefs. Open either one to see the before, the after, and exactly what changed.",
      ...
      proof_cred1: '7 years engineering',
      proof_cred2: 'One person on your project',
      proof_cred3: 'Audit in 2 days',
      proof_fn_role: 'Founder, TechPersona Studio',
      proof_fn_quote: "I build every site myself, from the first audit to launch. Every screen checked on a real phone, every page timed, every form and setting locked down, because I&rsquo;m asking what you&rsquo;d ask: would I trust this business if I landed here cold? You reach me directly, every time. No account managers, no handoffs, no guessing where your project stands.",
      proof_samples_head: 'Sample builds',
      proof_sample1: 'Real estate',
      proof_sample2: 'E-commerce',
      proof_cta: 'See both rebuilds in full <span class="a" aria-hidden="true">&#8594;</span>',
      ...
      about_intro: "TechPersona Studio is a web design agency in Worcester, MA, founded by Thao Phuong. The studio rebuilds websites for local businesses, from restaurants and salons to contractors, shops, and professional services, with a focus on lead conversion and local search visibility. Every project includes a free website audit before work begins.",
      ...
      about_studio: "TechPersona Studio is a one-person web design studio based in Worcester, MA. I redesign websites for local businesses, from restaurants and salons to contractors, shops, and professional services, so they show up in search and stop losing leads to competitors. Every project includes a free audit before any work begins.",
      ...
      about_p2: "I work with local businesses that are losing leads because of it. Restaurants, nail salons, plumbers, realtors, contractors, shops, and professional services. If you're running a real business and your website isn't helping you win customers, I want to hear about it.",
      ...
      faq_a2: "You reach me directly, every time, no account managers, no handoffs. Seven years of engineering means I've built my own tooling, so the repetitive parts of a build run themselves while every judgment call stays mine. You get the pace of a team and the accountability of one person whose name is on it.",
      faq_q3: 'What does it cost if I want you to build it?',
      faq_a3: 'Prices are right on this page, websites from $950, SEO from $97, automation from $499. Custom builds get scoped after the free audit, so you see the full number before you commit. Most first projects are one-time, not a monthly retainer.',
      ...
      faq_a8: "Restaurants, nail salons, hair salons, plumbers, electricians, HVAC companies, landscapers, realtors, contractors, shops, and other local businesses that rely on calls, bookings, or walk-ins. If a customer needs to find you online and reach you fast, that's the problem I solve.",
      ...
      build_03_tag_inline: 'Lead automation',
      ...
      offer_li6: 'Whether AI assistants like ChatGPT can read your site at all',
      offer_upsell: "<b>That's the website.</b> The full AI-search check, all seven areas, scored, is the $97 report, and it credits toward your fix sprint.",
    ...
    vi: {
      ...
      hero_location_line: 'Website, khả năng hiển thị trên tìm kiếm và tự động hóa lặng lẽ cho các doanh nghiệp cần nâng cấp trải nghiệm số.',
      ...
      // ---- /work measured speed ----
      perfk_qp_before: 'tệ nhất, khách phải chờ chừng đó mới thấy gì trên điện thoại',
      perfk_qp_after: 'nhanh hơn trên điện thoại',
      perfk_yg_before: 'trước khi ảnh chính hiện ra',
      ...
      // ---- /work teasers ----
      teaser_qp_name: 'Quán Phở',
      teaser_qp_kind: 'Nhà hàng Việt · Saugus, MA',
      teaser_yg_name: 'Young Group',
      teaser_yg_kind: 'Huấn luyện giảm cân · song ngữ, 7 trang',
      teaser_go: 'Xem những gì đã thay đổi <span class="a" aria-hidden="true">&#8594;</span>',

      // ---- /work page ----
      work_h1: 'Hai dự án, <span class="serif-i">trọn vẹn từ đầu đến cuối.</span>',
      work_lead: 'Cả hai website bên dưới đều do tôi tự đánh giá, thiết kế, xây dựng và bàn giao. Không thuê ngoài, không chuyển giao lòng vòng. Đây là những gì đã thay đổi, và vì sao.',
      work_label_before: 'Trước',
      work_label_after: 'Sau',
      qp_h2: 'Quán Phở, sau khi làm mới.',
      qp_lead: 'Một nhà hàng Việt ở Saugus, MA. Cùng một doanh nghiệp, nhưng ấn tượng đầu tiên hoàn toàn khác.',
      qp_ba_head: 'Thiết kế lại website nhà hàng',
      qp_ba_sub: 'Saugus, MA · thực đơn, đêm karaoke, tiệc riêng',
      qp_b1: 'Mẫu chung chung, ảnh stock không phải món Việt',
      qp_b2: 'Ba liên kết trên thanh điều hướng, không giờ mở cửa, không địa chỉ',
      qp_b3: 'Không hề nhắc đến đêm karaoke hay tiệc riêng',
      qp_b4: 'Điều hướng trên điện thoại không hoạt động',
      qp_a1: 'Món ăn thật và thương hiệu của họ được đưa lên hàng đầu',
      qp_a2: 'Hai lối rõ ràng: đặt món online, hoặc thuê trọn nhà hàng',
      qp_a3: 'Yêu cầu tiệc riêng đến email và tin nhắn của chủ quán trong vài giây',
      qp_a4: 'Chủ quán tự cập nhật thực đơn qua Google Sheet, không cần lập trình viên',
      qp_a5: 'Cắt 1,6 MB hình ảnh, nhẹ hơn 44%, chất lượng nhìn như cũ',
      qp_note: 'Được làm lại với sự cho phép. Website mới sẽ ra mắt theo nhịp của chủ quán.',
      yg_h2: 'Young Group, sau khi làm mới.',
      yg_lead: 'Một chương trình huấn luyện giảm cân 1–1 phục vụ khách Việt tại Mỹ, Việt Nam, Úc và Canada. Một trang landing đã trở thành website song ngữ bảy trang.',
      yg_ba_head: 'Thiết kế lại song ngữ & SEO cho huấn luyện sức khỏe',
      yg_live_badge: 'Xem website thật ↗',
      yg_ba_sub: 'Huấn luyện sức khỏe · tiếng Việt và tiếng Anh · 7 trang',
      yg_b1: 'Một trang landing dài, không có Giới thiệu, Kết quả, FAQ hay blog',
      yg_b2: 'Chỉ có tiếng Việt, hoàn toàn không có tiếng Anh',
      yg_b3: 'Kết quả khách hàng chìm trong một loạt ảnh khó đọc',
      yg_b4: 'Chỉ đạt 29/100 trong bài đánh giá SEO và tìm kiếm AI của tôi',
      yg_a1: 'Bảy trang: trang chủ, đội ngũ, kết quả, video, blog, FAQ, liên hệ',
      yg_a2: 'Song ngữ đúng nghĩa, trang tiếng Anh thật, không phải nút chuyển',
      yg_a3: 'Mỗi câu chuyện khách hàng mở riêng, kèm ảnh trước và sau',
      yg_a4: 'Được xây để Google và câu trả lời AI đọc đúng',
      yg_a5: 'Một blog kéo khách từ tìm kiếm, bài viết được viết và đăng thay cho chị',
      yg_note: 'Được làm lại với sự cho phép, hiện đã hoạt động tại <a href="https://tranthuytien.net" target="_blank" rel="noopener">tranthuytien.net</a>.',
      samples_h2: 'Bản mẫu tôi tự xây.',
      samples_lead: 'Đây là bản mẫu của tôi, không phải của khách hàng. Tôi làm để thử xem một ngành nên trông như thế nào. Không phải doanh nghiệp thật, không tuyên bố kết quả. Để bạn tự đánh giá tay nghề.',
      sample_1: 'Bất động sản',
      sample_2: 'Thương mại điện tử',
      work_cta_h2: 'Muốn biết website của bạn <span class="serif-i">có thể trông như thế nào?</span>',
      work_cta_btn: 'Gửi cho tôi URL của bạn <span class="ic" aria-hidden="true">&#8594;</span>',
      work_cta_trust: 'Miễn phí · không ràng buộc · đánh giá trong 2 ngày',
      build_h2: 'Website, khả năng hiển thị trên tìm kiếm và tự động hóa khách hàng tiềm năng cho doanh nghiệp ở Worcester, MA. <span class="serif-i">Chọn phần bạn cần.</span>',
      build_lead: 'Một phần giúp bạn được tìm thấy. Một phần giữ bạn hiện diện khi khách tìm kiếm, trên Google và trong câu trả lời của AI. Phần còn lại đảm bảo không ai bị bỏ lỡ sau khi đã liên hệ. Hãy bắt đầu với phần bạn cần nhất.',
      build_included: "Bắt đầu với bản kiểm tra miễn phí <span class=\"a\" aria-hidden=\"true\">&#8594;</span>",
      build_included_03: "Tìm ra cơ hội lớn nhất của bạn, miễn phí <span class=\"a\" aria-hidden=\"true\">&#8594;</span>",
      build_not_for: "Tôi thà làm kỹ một website còn hơn làm nhanh năm cái. Mỗi dự án đều được thiết kế từ đầu, đo tốc độ và bảo mật trước khi ra mắt, và thiết lập để công cụ tìm kiếm cùng AI đọc được. Đó không phải cách làm rẻ nhất, nên có lẽ tôi không phù hợp nếu giá là yếu tố quyết định.",
      ...
      build_01_li2: 'Được thiết lập để Google và câu trả lời AI đọc đúng doanh nghiệp của bạn.',
      build_01_li3: 'Mỗi trang đều hướng đến một bước tiếp theo rõ ràng: đặt lịch, gọi điện hoặc đặt hàng.',
      build_01_li4: 'Được thiết kế riêng cho bạn từ đầu, không phải mẫu có sẵn mà doanh nghiệp khác cũng đang dùng.',
      build_01_li5: 'Tốc độ và bảo mật được đo trước khi ra mắt, không chỉ là lời hứa.',
      build_01_tag: 'Chi phí triển khai một lần, rõ ràng trước khi bắt đầu. Nền móng nằm ở gói này; việc lên hạng theo thời gian thuộc Dịch vụ 02.',
      build_01_t1: 'Launch <em>1 trang</em>',
      build_01_t1_p: '$950',
      build_01_t2: 'Growth <em>2\u20135 trang</em>',
      build_01_t2_p: '$1,850',
      build_01_t3: 'Custom <em>6+ trang, đa ngôn ngữ</em>',
      build_01_t3_p: 'từ $2,500',
      build_02_t1: 'Báo cáo SEO & AI đầy đủ <em>có chấm điểm, một lần</em>',
      build_02_t1_p: '$97',
      build_02_t2: 'Đợt khắc phục <em>một lần</em>',
      build_02_t2_p: '$899',
      build_02_t3: 'Growth <em>hàng tháng</em>',
      build_02_t3_p: '$969/tháng',
      build_03_t1: 'Không bỏ lỡ cuộc gọi <em>nhắn lại tự động</em>',
      build_03_t1_p: '$499 + $79/tháng',
      build_03_t2: 'Thu khách tiềm năng <em>+ định tuyến biểu mẫu</em>',
      build_03_t2_p: '$899 + $149/tháng',
      build_03_t3: 'Hệ thống tùy chỉnh <em>báo giá riêng</em>',
      build_03_t3_p: 'từ $1,500',
      build_promise: 'Bản kiểm tra đầu tiên luôn miễn phí dù bạn chọn dịch vụ nào. Mọi mức giá bên dưới đều là giá thật, bạn không bao giờ phải đặt lịch gọi chỉ để biết chi phí.',
      build_02_num: 'Dịch vụ 02',
      build_02_h3: 'SEO & tìm kiếm AI',
      build_02_body: 'Google vẫn đưa người dùng đến một danh sách liên kết. ChatGPT, Perplexity và câu trả lời AI của Google thì đọc website của bạn rồi gọi tên một doanh nghiệp, hoặc bỏ qua bạn vì không đọc được. Tôi làm cả hai.',
      build_02_scenario: 'Ai đó hỏi ChatGPT nên gọi thợ nào để sửa mái nhà bị dột ở Worcester. <b>Doanh nghiệp của bạn được gọi tên</b>, vì website của bạn được xây dựng để AI đọc được.',
      build_02_li1: 'Được tìm thấy trên Google và được trích dẫn trong câu trả lời của AI.',
      build_02_li2: 'Hồ sơ Google Business thực sự mang lại cuộc gọi.',
      build_02_li3: 'Bài viết trả lời đúng những gì khách hàng của bạn đang tìm kiếm.',
      build_02_tag: 'Phí kiểm tra được trừ vào đợt khắc phục \u00b7 tối thiểu 3 tháng cho gói Growth',
      build_03_num: 'Dịch vụ 03',
      build_03_h3: 'Hệ thống tiếp nhận khách hàng',
      build_03_body: 'Giải pháp giữ chân khách hàng hoạt động trong khi bạn làm việc. Cuộc gọi nhỡ và tin nhắn ngoài giờ nhận được phản hồi thân thiện ngay lập tức và đến đúng người cần xử lý.',
      build_03_scenario: 'Một yêu cầu mới đến lúc 11 giờ đêm. <b>Hệ thống của bạn nhắn lại trong chưa đầy 2 phút</b> kèm liên kết đặt lịch. Sáng ra bạn đã có một cuộc hẹn được lên lịch.',
      build_03_li1: 'Không có gì để bạn phải học hay đăng nhập.',
      build_03_li2: 'Hoạt động lặng lẽ phía sau.',
      build_03_li3: 'Tích hợp với bất kỳ website nào, của tôi hoặc của bạn.',
      build_03_tag: 'Bổ sung hoặc dùng độc lập \u00b7 phí điện thoại và SMS trả theo giá gốc',

      proof_h2: 'Hai doanh nghiệp, sau khi làm mới.',
      proof_lead: 'Khách hàng thật, yêu cầu thật. Mở từng dự án để xem trước, sau, và chính xác điều gì đã thay đổi.',
      ...
      proof_cred1: '7 năm kỹ thuật',
      proof_cred2: 'Một người phụ trách',
      proof_cred3: 'Đánh giá trong 2 ngày',
      proof_fn_role: 'Người sáng lập, TechPersona Studio',
      proof_fn_quote: "Tôi tự tay xây từng website, từ buổi đánh giá đầu tiên đến lúc ra mắt. Từng màn hình được kiểm tra trên điện thoại thật, từng trang được đo tốc độ, từng biểu mẫu và thiết lập được khóa an toàn, vì tôi đang tự hỏi đúng điều bạn sẽ hỏi: nếu lần đầu ghé vào đây, tôi có tin doanh nghiệp này không? Bạn làm việc trực tiếp với tôi, mọi lúc. Không qua trung gian, không chuyển giao lòng vòng, không phải đoán xem dự án đang đến đâu.",
      proof_samples_head: 'Mẫu đã xây dựng',
      proof_sample1: 'Bất động sản',
      proof_sample2: 'Thương mại điện tử',
      proof_cta: 'Xem đầy đủ cả hai dự án <span class="a" aria-hidden="true">&#8594;</span>',
      ...
      about_studio: 'TechPersona Studio là một studio thiết kế web do một mình tôi điều hành, đặt tại Worcester, MA. Tôi thiết kế lại website cho các doanh nghiệp địa phương, từ nhà hàng và tiệm salon đến nhà thầu, cửa hàng và các dịch vụ chuyên môn, để họ xuất hiện trên tìm kiếm và không còn mất khách vào tay đối thủ. Mỗi dự án đều bắt đầu bằng một bản đánh giá miễn phí trước khi công việc khởi động.',
      about_p1: 'Tôi có 7 năm viết phần mềm cho các công ty công nghệ lớn ở Boston, MA. Tôi lập TechPersona Studio để mang chính kỹ thuật đó phục vụ các doanh nghiệp nhỏ, những nơi thường bị bỏ qua và tụt lại về công nghệ. Mục tiêu của tôi rất đơn giản: mang đến cho bạn tốc độ và công cụ mà các ông lớn đang có, để bạn bắt kịp và giành chiến thắng.',
      ...
      faq_a2: 'Bạn làm việc trực tiếp với tôi, mọi lúc, không qua trung gian, không chuyển giao lòng vòng. Bảy năm kỹ thuật giúp tôi tự xây bộ công cụ riêng, nên phần việc lặp lại tự chạy còn mọi quyết định quan trọng vẫn do tôi. Bạn có tốc độ của một đội ngũ và trách nhiệm của một người đặt tên mình lên đó.',
      faq_q3: 'Chi phí bao nhiêu nếu tôi muốn bạn xây dựng?',
      faq_a3: 'Giá đã có sẵn ngay trên trang này, website từ $950, SEO từ $97, tự động hóa từ $499. Dự án tùy chỉnh được báo giá sau buổi kiểm tra miễn phí, nên bạn thấy con số đầy đủ trước khi cam kết. Hầu hết dự án đầu tiên là chi phí một lần, không phải phí hàng tháng.',
      ...
      faq_q7: 'Bạn có làm việc với doanh nghiệp ngoài Worcester, MA không?',
      faq_a7: 'Có. Toàn bộ quy trình đều làm từ xa, nên vị trí không phải là rào cản. Phần lớn khách hàng ở khu vực Worcester và Boston mở rộng, nhưng tôi làm việc với các doanh nghiệp dịch vụ trên khắp nước Mỹ.',
      faq_q8: 'Bạn làm việc với những loại hình doanh nghiệp dịch vụ nào?',
      faq_a8: 'Nhà hàng, tiệm nail, tiệm tóc, thợ sửa ống nước, thợ điện, công ty HVAC, dịch vụ cảnh quan, môi giới bất động sản, nhà thầu, cửa hàng và các doanh nghiệp địa phương khác sống nhờ cuộc gọi, lượt đặt chỗ hoặc khách ghé trực tiếp. Nếu khách hàng cần tìm thấy bạn trên mạng và liên hệ được nhanh, đó chính là vấn đề tôi giải quyết.',
      faq_q9: 'Hệ thống tiếp nhận khách hàng là gì và hoạt động ra sao?',
      faq_a9: 'Đó là hệ thống tự động theo sát khách hàng tiềm năng, chạy âm thầm trong lúc bạn làm việc. Khi ai đó gửi biểu mẫu liên hệ hoặc gọi ngoài giờ, hệ thống lập tức gửi một tin nhắn thân thiện kèm đường dẫn đặt lịch. Bạn thức dậy với một cuộc hẹn đã lên lịch thay vì một khách hàng nguội lạnh. Bạn không phải đăng nhập hay quản lý gì cả, và nó hoạt động cùng bất kỳ website nào, của tôi hay của bạn.',
      build_03_tag_inline: 'Tự động hoá',
      ...
      offer_li6: 'Liệu các trợ lý AI như ChatGPT có đọc được website của bạn hay không',
      offer_upsell: '<b>Đó là phần website.</b> Bản kiểm tra AI đầy đủ, cả bảy hạng mục, có chấm điểm, là báo cáo $97, và phí này được trừ vào đợt khắc phục.',
