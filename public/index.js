(function(){
  ...
  var STRINGS = {
    en: {
      ...
      yg_note: "Rebuilt with permission. The new site goes live at the owner's pace.",
      ...
      faq_a2: "You reach me directly, every time, no account managers, no handoffs. Six years of engineering means I've built my own tooling, so the repetitive parts of a build run themselves while every judgment call stays mine. You get the pace of a team and the accountability of one person whose name is on it.",
    ...
    vi: {
      ...
      yg_note: 'Được làm lại với sự cho phép. Website mới sẽ ra mắt theo nhịp của chủ doanh nghiệp.',
      ...
      faq_a2: 'Bạn làm việc trực tiếp với tôi, mọi lúc, không qua trung gian, không chuyển giao lòng vòng. Sáu năm kỹ thuật giúp tôi tự xây bộ công cụ riêng, nên phần việc lặp lại tự chạy còn mọi quyết định quan trọng vẫn do tôi. Bạn có tốc độ của một đội ngũ và trách nhiệm của một người đặt tên mình lên đó.',
