(function(){
  ...
  var STRINGS = {
    en: {
      ...
      build_not_for: "Probably not a fit if you want the cheapest quote on the market, need a large online store, or want a mobile app. I'd rather say so now than take the project.",
      ...
      build_01_anchor: "Agencies sell the website and the search setup as <b>two services</b>. Here they're one build.",
      build_02_anchor: "Agencies charge <b>$1,500\u2013$3,000 a month</b> for the AI-search half alone. It's included here.",
      build_03_anchor: 'A missed call goes to the next name on the list. <b>$79 a month is less than one lost job.</b>',
    ...
    vi: {
      ...
      build_not_for: 'Có lẽ không phù hợp nếu bạn muốn báo giá rẻ nhất thị trường, cần một cửa hàng trực tuyến lớn, hoặc muốn làm ứng dụng di động. Tôi thà nói trước còn hơn nhận dự án.',
      ...
      build_01_anchor: 'Các agency bán website và thiết lập tìm kiếm thành <b>hai dịch vụ riêng</b>. Ở đây là một gói.',
      build_02_anchor: 'Các agency tính <b>$1,500\u2013$3,000 mỗi tháng</b> chỉ riêng phần tìm kiếm AI. Ở đây đã bao gồm sẵn.',
      build_03_anchor: 'Một cuộc gọi nhỡ sẽ đến tay cái tên tiếp theo trong danh sách. <b>$79 mỗi tháng còn rẻ hơn một đơn hàng bị mất.</b>',
